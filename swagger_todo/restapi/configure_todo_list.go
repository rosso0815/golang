...
import (
	...
	"github.com/rosso0815/golang/swagger_todo/restapi/operations"
	"github.com/rosso0815/golang/swagger_todo/restapi/operations/todos"
)

//go:generate swagger generate server --target ../../swagger_todo --name TodoList --spec ../swagger.yml --principal interface{}
