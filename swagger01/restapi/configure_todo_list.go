...
import (
	...
	"pfistera/swagger01/restapi/operations"
	"pfistera/swagger01/restapi/operations/todos"
)

//go:generate swagger generate server --target ../../swagger01 --name TodoList --spec ../swagger.yml
